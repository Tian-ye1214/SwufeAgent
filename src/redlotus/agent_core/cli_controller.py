...
from redlotus.cli.file_ref import augment_text_with_file_refs, load_file_refs
...
class AgentCliController:
    ...
    BUSY_SAFE_COMMANDS = {"/stop", "/status", "/cancel", "/help", "/trace", "/tasks", "/pwd", "/config", "/context", "/usage", "/panel", "/skills", "/ltm", "/stm"}
