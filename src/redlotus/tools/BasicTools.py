...
from redlotus.config.app_config import get_agent_run_policy, get_env
from redlotus.skills.SkillsManager import SkillsManager
from redlotus.skills.SkillsTools import SkillsToolkit
...
# 运行时技能安装：clawhub 以用户数据目录为 cwd，`--dir skills` 即落到可写 overlay
_CLAWHUB_CWD = user_data_dir()
_SKILLS_OVERLAY = user_skills_dir()
