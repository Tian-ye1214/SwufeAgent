...
from redlotus.tools.conversation_log import drain_pending_saves
from redlotus.workspace.workspace import WorkspaceSnapshot, conversations_root
from redlotus.workspace.workspace_load import enter_workspace
from redlotus.cli.render import console, print_error, print_markdown, print_markdown_panel, print_panel, print_success, print_warning
from redlotus.cli.panel import build_panel_snapshot, render_panel
from redlotus.cli.completion import EFFORT_VALUES
...
- **新任务** — 清空上下文并开启新对话（同 `/clear`，旧快照保留在 `.redlotus`）
- **quit / exit** — 退出
